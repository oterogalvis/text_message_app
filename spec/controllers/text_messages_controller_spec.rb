...
describe TextMessagesController do
  ...
  describe "GET index" do
    it "assigns all text_messages as @text_messages" do
      ...
      assigns(:text_messages).should eq([text_message])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested text_message as @text_message" do
      ...
      assigns(:text_message).should eq(text_message)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved text_message as @text_message" do
        ...
        post :create, {:text_message => { "number" => "invalid value" }}, valid_session
        assigns(:text_message).should be_a_new(TextMessage)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested text_message" do
        text_message = TextMessage.create! valid_attributes
        # Assuming there are no other text_messages in the database, this
        # specifies that the TextMessage created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        TextMessage.any_instance.should_receive(:update).with({ "number" => "MyString" })
        put :update, {:id => text_message.to_param, :text_message => { "number" => "MyString" }}, valid_session
      end
      ...
      it "redirects to the text_message" do
        text_message = TextMessage.create! valid_attributes
        put :update, {:id => text_message.to_param, :text_message => valid_attributes}, valid_session
        response.should redirect_to(text_message)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the text_message as @text_message" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        TextMessage.any_instance.stub(:save).and_return(false)
        put :update, {:id => text_message.to_param, :text_message => { "number" => "invalid value" }}, valid_session
        assigns(:text_message).should eq(text_message)
      end
